...
export async function POST(req: NextRequest) {
  ...
  for (const rec of recurringInvoices || []) {
    ...
    const invoiceNumber = 'REC-' + new Date().getFullYear() + '-' + String(rec.invoice_count + 1).padStart(3, '0')
    ...
    const { data: invoice } = await supabaseAdmin
      ...
      .insert({
        ...
        due_at: getNextDate(today, rec.frequency)
      })
      .select()
      .single()
            ...
            <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:600px;margin:0 auto;background:#ffffff">
              ...
              <div style="padding:40px;border:1px solid #E2E8F0;border-top:none;border-radius:0 0 12px 12px">
                ...
                <p style="font-size:14px;color:#475569;margin:0 0 24px">
                  A new invoice has been generated by <strong>${firm?.name || 'your firm'}</strong>.
                </p>
                <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:12px;padding:24px;margin:0 0 24px">
                  ...
                  <div style="margin-bottom:12px">
                    ...
                    <p style="font-size:28px;font-weight:900;color:#1C64F2;margin:0">$${rec.amount.toLocaleString()}</p>
                  </div>
                  <div>
                    <p style="font-size:12px;color:#64748B;margin:0 0 4px">Due date</p>
                    <p style="font-size:14px;font-weight:600;color:#DC2626;margin:0">${new Date(getNextDate(today, rec.frequency)).toLocaleDateString('en-GB',{day:'numeric',month:'long',year:'numeric'})}</p>
                  </div>
                </div>
