    ...
    html: (email: string) => `
      <div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto">
        ...
        <div style="background:#fff;padding:28px;border:1px solid #E2E8F0;border-radius:0 0 12px 12px">
          ...
          <a href="https://firmflow.io/demo" style="display:inline-block;background:#1C64F2;color:#fff;padding:14px 28px;border-radius:10px;text-decoration:none;font-weight:700;font-size:15px;margin:16px 0">Book a free demo →</a>
          ...
          <p style="font-size:12px;color:#94A3B8"><a href="https://firmflow.io" style="color:#94A3B8">Unsubscribe</a></p>
        </div>
      </div>
    `,
  },
    ...
    html: (email: string) => `
      <div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto">
        ...
        <div style="background:#fff;padding:28px;border:1px solid #E2E8F0;border-radius:0 0 12px 12px">
          ...
          <a href="https://firmflow.io/signup" style="display:inline-block;background:#1C64F2;color:#fff;padding:14px 28px;border-radius:10px;text-decoration:none;font-weight:700;font-size:15px;margin:16px 0">Start your free 14-day trial →</a>
    ...
    html: (email: string) => `
      <div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto">
        ...
        <div style="background:#fff;padding:28px;border:1px solid #E2E8F0;border-radius:0 0 12px 12px">
          ...
          <a href="https://firmflow.io/signup" style="display:inline-block;background:#1C64F2;color:#fff;padding:14px 28px;border-radius:10px;text-decoration:none;font-weight:700;font-size:15px;margin:16px 0">Give it a try →</a>
          
          <p style="font-size:14px;color:#64748B;margin-top:20px">Either way, I wish you and your firm all the best.</p>
          <p style="font-size:14px;color:#64748B">— The FirmFlow Team</p>
          <hr style="border:none;border-top:1px solid #E2E8F0;margin:20px 0"/>
          <p style="font-size:12px;color:#94A3B8">You won't hear from us again. <a href="https://firmflow.io" style="color:#94A3B8">Visit FirmFlow</a></p>
        </div>
      </div>
    `,
  },
