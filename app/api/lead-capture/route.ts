      ...
      html: `
        <div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto">
          ...
          <div style="background:#fff;padding:28px;border:1px solid #E2E8F0;border-radius:0 0 12px 12px">
            ...
            <p style="font-size:13px;color:#94A3B8">You received this because you used our savings calculator at firmflow.io. <a href="https://firmflow.io" style="color:#94A3B8">Unsubscribe</a></p>
          </div>
        </div>
      `,
    }
      ...
      html: `
        <div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto">
          ...
          <div style="background:#fff;padding:28px;border:1px solid #E2E8F0;border-radius:0 0 12px 12px">
            ...
            <a href="https://firmflow.io/signup" style="display:inline-block;background:#1C64F2;color:#fff;padding:14px 28px;border-radius:10px;text-decoration:none;font-weight:700;font-size:15px;margin:16px 0">Try FirmFlow free for 14 days →</a>
    ...
    html: `
      <div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto">
        ...
        <div style="background:#fff;padding:28px;border:1px solid #E2E8F0;border-radius:0 0 12px 12px">
          ...
          <a href="https://firmflow.io/signup" style="display:inline-block;background:#1C64F2;color:#fff;padding:14px 28px;border-radius:10px;text-decoration:none;font-weight:700;font-size:15px;margin:16px 0">Start free trial →</a>
        </div>
      </div>
    `,
  }
