...
export async function POST(req: NextRequest) {
  try {
    ...
    const sessionParams: Stripe.Checkout.SessionCreateParams = {
      ...
      success_url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://firmflow.io'}/dashboard/subscription?upgraded=true`,
      cancel_url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://firmflow.io'}/dashboard/subscription`,
      subscription_data: {
