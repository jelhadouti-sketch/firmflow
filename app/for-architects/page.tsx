...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://firmflow.io/for-architects' },
  openGraph: {
    title: "Practice Management Software for Architecture Firms",
    description: "Project agreements, document management, time tracking, and invoicing for solo architects and small architecture practices. EUR 29/month flat.",
    url: 'https://firmflow.io/for-architects',
    type: 'website',
...
const useCases: UseCase[] = JSON.parse('[{"title": "Project agreements", "desc": "Send architectural service agreements with e-signature. Standard contract templates included. Legally binding under eIDAS."}, {"title": "Document sharing", "desc": "Share large architectural drawings (PDFs, images) securely with clients. Version control. No file size limits within plan storage."}, {"title": "Time tracking per project", "desc": "Track billable time per project, per phase. Differentiate design phases (concept, schematic, construction docs) for clear client billing."}, {"title": "Multi-currency invoicing", "desc": "Invoice clients in EUR, GBP, USD, CHF, and 6 other currencies. Stripe-integrated payments with automatic settlement to your bank."}]')

export default function Page() {
  return (
    <>
      <Breadcrumbs schemaOnly items={[{ name: "For Architects", href: '/for-architects' }]} />
      <SiteHeader />
      ...
      <main style={{ maxWidth: 1100, margin: '0 auto', padding: '60px 24px 100px' }}>
        ...
        <section style={{ textAlign: 'center', marginBottom: 64 }}>
          <p style={{ color: BLUE, fontWeight: 700, fontSize: 13, textTransform: 'uppercase', letterSpacing: '0.08em', margin: '0 0 12px' }}>For architects</p>
          ...
          <p style={{ fontSize: 18, color: MUTED, maxWidth: 640, margin: '0 auto 32px', lineHeight: 1.6 }} dangerouslySetInnerHTML={{ __html: "Built for solo architects and small architecture practices who need project agreements, document sharing, time tracking, and invoicing in one platform." }} />
        ...
        <section style={{ marginBottom: 80 }}>
          <h2 style={{ fontSize: 28, fontWeight: 800, color: NAVY, letterSpacing: '-0.025em', margin: '0 0 8px', textAlign: 'center' }}>What FirmFlow does for architects</h2>
