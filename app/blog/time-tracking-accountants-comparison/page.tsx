...
export const metadata: Metadata = {
  alternates: { canonical: 'https://www.firmflow.org/blog/time-tracking-accountants-comparison' },
  ...
  openGraph: {
    title: "Time Tracking for Accountants: Software Comparison (2026)",
    description: "Compare time tracking software for accounting firms. Standalone tools (Harvest, Toggl) vs integrated practice management (FirmFlow, Karbon, TaxDome).",
    url: 'https://www.firmflow.org/blog/time-tracking-accountants-comparison',
    type: 'article',
...
export default function Post() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"Article\",\"datePublished\":\"2026-04-28T09:00:00Z\",\"dateModified\":\"2026-04-28T09:00:00Z\",\"headline\":\"Time Tracking for Accountants: Software Comparison (2026)\",\"description\":\"Compare time tracking software for accounting firms. Standalone tools (Harvest, Toggl) vs integrated practice management (FirmFlow, Karbon, TaxDome).\",\"url\":\"https://www.firmflow.org/blog/time-tracking-accountants-comparison\",\"image\":\"https://www.firmflow.org/og-default.png\",\"author\":{\"@type\":\"Organization\",\"name\":\"FirmFlow\",\"url\":\"https://www.firmflow.org\"},\"publisher\":{\"@type\":\"Organization\",\"name\":\"FirmFlow\",\"logo\":{\"@type\":\"ImageObject\",\"url\":\"https://www.firmflow.org/logo/firmflow-icon.svg\"}},\"mainEntityOfPage\":{\"@type\":\"WebPage\",\"@id\":\"https://www.firmflow.org/blog/time-tracking-accountants-comparison\"}}"}} />
