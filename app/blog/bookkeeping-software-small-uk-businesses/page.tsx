...
export const metadata: Metadata = {
  alternates: { canonical: 'https://firmflow.io/blog/bookkeeping-software-small-uk-businesses' },
  ...
  openGraph: {
    title: "Bookkeeping Software for Small UK Businesses (2026 Guide)",
    description: "A practical guide to bookkeeping software for UK small businesses. MTD-compatible options, what to look for, and what you actually need vs nice-to-have features.",
    url: 'https://firmflow.io/blog/bookkeeping-software-small-uk-businesses',
    type: 'article',
...
export default function Post() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: "{\"@context\":\"https://schema.org\",\"@type\":\"Article\",\"datePublished\":\"2026-04-28T09:00:00Z\",\"dateModified\":\"2026-04-28T09:00:00Z\",\"headline\":\"Bookkeeping Software for Small UK Businesses (2026 Guide)\",\"description\":\"A practical guide to bookkeeping software for UK small businesses. MTD-compatible options, what to look for, and what you actually need vs nice-to-have features.\",\"url\":\"https://firmflow.io/blog/bookkeeping-software-small-uk-businesses\",\"image\":\"https://firmflow.io/og-default.png\",\"author\":{\"@type\":\"Organization\",\"name\":\"FirmFlow\",\"url\":\"https://firmflow.io\"},\"publisher\":{\"@type\":\"Organization\",\"name\":\"FirmFlow\",\"logo\":{\"@type\":\"ImageObject\",\"url\":\"https://firmflow.io/logo/firmflow-icon.svg\"}},\"mainEntityOfPage\":{\"@type\":\"WebPage\",\"@id\":\"https://firmflow.io/blog/bookkeeping-software-small-uk-businesses\"}}"}} />
