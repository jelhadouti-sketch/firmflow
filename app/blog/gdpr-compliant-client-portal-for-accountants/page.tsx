...
export const metadata: Metadata = {
  alternates: { canonical: 'https://www.firmflow.org/blog/gdpr-compliant-client-portal-for-accountants' },
  ...
  openGraph: {
    ...
    url: 'https://www.firmflow.org/blog/gdpr-compliant-client-portal-for-accountants',
    type: 'article',
...
export default function Post() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({"@context":"https://schema.org","@type":"Article","datePublished":"2026-04-27T09:00:00Z","dateModified":"2026-04-28T09:00:00Z","headline":"GDPR-Compliant Client Portal for Accountants (2026 Guide)","description":"What makes a client portal truly GDPR-compliant: data residency, encryption, access logs, and consent management.","url":"https://www.firmflow.org/blog/gdpr-compliant-client-portal-for-accountants","image":"https://www.firmflow.org/og-default.png","author":{"@type":"Organization","name":"FirmFlow","url":"https://www.firmflow.org"},"publisher":{"@type":"Organization","name":"FirmFlow","logo":{"@type":"ImageObject","url":"https://www.firmflow.org/logo/firmflow-icon.svg"}},"mainEntityOfPage":{"@type":"WebPage","@id":"https://www.firmflow.org/blog/gdpr-compliant-client-portal-for-accountants"}})}} />
