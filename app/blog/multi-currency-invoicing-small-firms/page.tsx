...
export const metadata: Metadata = {
  alternates: { canonical: 'https://firmflow.io/blog/multi-currency-invoicing-small-firms' },
  ...
  openGraph: {
    ...
    url: 'https://firmflow.io/blog/multi-currency-invoicing-small-firms',
    type: 'article',
...
export default function Post() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({"@context":"https://schema.org","@type":"Article","datePublished":"2026-04-28T09:00:00Z","dateModified":"2026-04-28T09:00:00Z","headline":"How to Invoice Clients in Multiple Currencies (2026 Guide)","description":"A practical guide to multi-currency invoicing for small firms.","url":"https://firmflow.io/blog/multi-currency-invoicing-small-firms","image":"https://firmflow.io/og-default.png","author":{"@type":"Organization","name":"FirmFlow","url":"https://firmflow.io"},"publisher":{"@type":"Organization","name":"FirmFlow","logo":{"@type":"ImageObject","url":"https://firmflow.io/logo/firmflow-icon.svg"}},"mainEntityOfPage":{"@type":"WebPage","@id":"https://firmflow.io/blog/multi-currency-invoicing-small-firms"}})}} />
